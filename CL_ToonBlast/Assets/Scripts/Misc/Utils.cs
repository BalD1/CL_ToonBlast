...
namespace BalDUtilities
{
    ...
    namespace CreateUtils
    {
        ...
        {
            public static TextMesh CreateWorldText(string _text, Vector3 _localPosition, int _fontSize) =>
                CreateWorldText(_text, _localPosition, _fontSize, Color.white, TextAnchor.MiddleCenter, TextAlignment.Center, 0);
